...
> **关联文档**：[10-角色性格属性系统.md](./10-角色性格属性系统.md)（v1.0 锁定 · 2026-08-08）。性格的主战场=事件，事件选项拉动性格阳/阴；灵魂由人际+战斗驱动，肉体由战斗/身法体质驱动。
...
> **性格主战场说明**（见 [10-角色性格属性系统.md](./10-角色性格属性系统.md) §一）：本系统的事件选项结算会拉动角色性格·阳/阴（价值取向）；灵魂（人际+战斗响应）与肉体（战斗/身法体质）不在本系统主战场，由对应体验驱动。
...
> ✅ **已统一**：境界体系锁定为 5 阶（练气 / 筑基 / 金丹 / 元婴 / 化神），文档与 `realms.ts` 一致。事件中 `realmRange` 使用此短列表。
...
| 性格偏移字段 | 文档基于旧 10 维 yin/yang；与代码均需对齐 10-角色性格属性系统 v1.0 三层结构（性格阳/阴 + 灵魂 + 肉体） | 同上 |
...
|------|------|------|
| v1.0 | — | 初版 |
| v1.1 | 2026-08-13 | 关联 10-角色性格属性系统 v1.0；标注性格主战场=事件；性格偏移字段待对齐 v1.0 三层结构 |