...
| 文档章节 | 设计位置 | 实际代码位置 |
|----------|----------|--------------|
| 游戏时间模型 | 07-时间系统.md §2 | `src/types/time.ts` |
| 闰年算法 | 07-时间系统.md §3 | `src/types/time.ts` |
| 事件时间消耗 | 07-时间系统.md §4 | ⚠️ `accountStore.resolveEvent` BUG |
| 周天时间 | 07-时间系统.md §5 | ❌ 未实现 |
| Idle tick | 07-时间系统.md §6.2 | ⚠️ `accountStore.tickIdle` BUG |
| UI显示 | 07-时间系统.md §7 | `GameScreen.tsx:264` |
| 存档 | 07-时间系统.md §11 | `accountStore.ts` |
